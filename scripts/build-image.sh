...
case "${IMAGE_PROFILE}" in
  ...
  kimi-k3)
    ...
    ;;
  ornith15)
    DEFAULT_DEF="${PROJECT_DIR}/apptainer/ornith15-ollama.def"
    DEFAULT_OUTPUT="${PROJECT_DIR}/ornith15-ollama.sif"
    ;;
  *)
    echo "ERROR: IMAGE_PROFILE must be qwen38, deepseek-v4-pro, kimi-k3, or ornith15" >&2
    exit 4
    ;;
esac
